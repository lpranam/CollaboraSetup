...
sudo apt install -y libpoco-dev python3-polib libcap-dev npm libpam-dev libzstd-dev wget git build-essential libtool libcap2-bin python3-lxml libpng-dev libcppunit-dev pkg-config fontconfig snapd pulseaudio-utils docker.io
